// Mock data for the E-Moped business plan presentation

export const businessPlanData = {
  executiveSummary: {
    projectName: "E-Moped Üretimi & Batarya Dolum Servisi",
    actors: [
  ...
  products: {
    equipment: [
      { name: "Montaj Hattı", supplier: "Jinggong", imageUploaded: false },
      { name: "Boru Bükme Makinası", supplier: "Sanco", imageUploaded: false },
      { name: "Lazer Kaynak Makinası", supplier: "Lingping", imageUploaded: false }
    ],
    emoped: {
      model: "BODYGUARD",
      specs: [
